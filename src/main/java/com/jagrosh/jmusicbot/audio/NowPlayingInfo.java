...
public class NowPlayingInfo {
    ...
    /** Não nulo quando o guild está no modo fase; aí o áudio não vem do lavaplayer. */
    public final SegmentPlayer segmentPlayer;
    ...
    public NowPlayingInfo(
        ...
        this(track, guild, isPaused, volume, queueSize, previousTrackCount, isCurrentTrackFavorited,
                footerInfo, null);
    }
