...
public final class OutputAdapters {
    ...
    /**
     * Adapter para ações de fase que já deram deferReply: a decodificação do trecho leva
     * segundos, então o retorno vai pelo hook em vez de uma resposta direta (que expiraria).
     */
    public static MusicService.OutputAdapter forPhaseDeferred(net.dv8tion.jda.api.interactions.callbacks.IDeferrableCallback event) {
        return new MusicService.OutputAdapter() {
