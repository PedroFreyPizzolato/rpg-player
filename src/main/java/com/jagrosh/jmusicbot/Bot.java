...
public class Bot
{
    ...
    /** Criado sob demanda: registra as fontes de áudio de novo, só vale a pena se for usado. */
    private SegmentCapture segmentCapture;
    ...
    {
        if (segmentCapture == null)
            segmentCapture = new SegmentCapture(config);
        return segmentCapture;
    }
